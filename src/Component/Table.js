...
const Table = () => {
  ...
  return (
    <>
      <div className="md:relative xl:top-[8rem] md:top-[10rem] left-[13rem] overflow-x-auto shadow-md sm:rounded-lg">
        <table className=" text-sm w-[85%]  text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {tableValues.map((item, index) => (
              ...
              >
                ...
                <td className="px-6 py-4 text-center align-middle">{item}</td>
                <td className="px-6 py-4 text-center align-middle">
                  1st Time Neogation
                </td>
                <td className="px-6 py-4 text-center align-middle">
